...
%>  
	...
	<h3>  SHOPPING CART<a href="products.jsp" class="btn btn-large pull-right"><i class="icon-arrow-left"></i> Continue Shopping </a></h3>	
	<hr class="soft"/>
	<form action="">
...
<%	} %>                				
	...
	<a href="product_summary.jsp" class="btn btn-large pull-right">進行結帳<i class="icon-arrow-right"></i></a>
